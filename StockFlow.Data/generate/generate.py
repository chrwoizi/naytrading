...
class BuyConfig(WellFormedConfig):
    def __init__(self):
        super().__init__()
        self.end = 0

class SellConfig(WellFormedConfig):
    def __init__(self):
        super().__init__()
        self.end = 1

class IgnoreConfigLow(WellFormedConfig):
    def __init__(self):
        super().__init__()
        self.end = 0.3

class IgnoreConfigMid(WellFormedConfig):
    def __init__(self):
        super().__init__()
        self.end = 0.5

class IgnoreConfigHigh(WellFormedConfig):
    def __init__(self):
        super().__init__()
        self.end = 0.7

class IgnoreConfigBearish(WellFormedConfig):
    def __init__(self):
        super().__init__()
        self.gradient = -random_range(0.005, 2)
        self.end = random_range(0, 1)

class IgnoreConfigWide(WellFormedConfig):
    def __init__(self):
        super().__init__()
        self.y_base = random_range(1, 100)
...
class IgnoreConfigJitter(WellFormedConfig):
    def __init__(self):
        super().__init__()
        self.gradient = random_range(-2, 2)
...
if __name__ == '__main__':
    ...
    sell_generators = {
        0: lambda: generate_well_formed(IgnoreConfigLow()),
        0: lambda: generate_well_formed(IgnoreConfigMid()),
        1: lambda: generate_well_formed(IgnoreConfigHigh()),
        2: lambda: generate_well_formed(IgnoreConfigBearish()),
        3: lambda: generate_well_formed(IgnoreConfigWide()),
        4: lambda: generate_well_formed(IgnoreConfigJitter()),
    ...
    generate_file('data/train_buying.csv', FLAGS.train)
    generate_file('data/test_buying.csv', FLAGS.test)